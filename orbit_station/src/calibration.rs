...
// use std::{io};
// use apriltag::{ApriltagDetector, NoTagFound, EulerAngles};
// use std::path::Path;
// use crate::mpeg_encoder::Encoder;
// use image::{DynamicImage, GenericImageView, GrayImage};
// use crate::picture::crop_rotate_dimensions;
...
//
//         let (new_width, new_height) = crop_rotate_dimensions(input_width, input_height, roll);
//
...
//     pub fn calibrate(_pictures: &[DynamicImage], _parameters: CameraParameters, _detector: &mut ApriltagDetector) -> OrbitResult<CalibrationResult> {
...
//
// impl Adjustment {
//     fn from_image(image: &GrayImage, detector: &mut ApriltagDetector) -> Result<Adjustment, NoTagFound> {
//         let euler_angles = detector.search(
//             image,
//             image.width(),
//             image.height(),
//             TAG_SIZE_METERS,
...
//         let roll = self.euler_angles.roll as f32;
//         let pitch = self.euler_angles.pitch as f32;
//
